    ...
    stages {
        ...
        stage('Reporting') {
            steps {
				...
				emailext body: attachmentsPattern: '$WORKSPACE/results/instance_$BUILD_NUMBER.tar.gz', 'Pipeline Automacao - Build # $BUILD_NUMBER - $BUILD_STATUS!', subject: 'Pipeline Automacao - Build # $BUILD_NUMBER - $BUILD_STATUS!', to: 'mateus@caletti.com.br'
            }
        }
    }
}
